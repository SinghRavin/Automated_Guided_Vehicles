...
function probmat = DS_Diagonal_LongTermProbFunction(a,b,m)
    % a = x-axis length 
    % b = y-axis length First
    % m = number of static obstacles placed along diagonal
    ...
    % Introducing obstacles (placed diagonally), and updating D matrix accordingly
